...
if __name__ == '__main__':
    ...
    #            continue
            ...
            mtime = time.ctime(os.path.getmtime('./client' +str(q)+'/'+frame_img[frame_cnt]))
            mtime = mtime[11:13]+mtime[14:16]+mtime[17:19]
            mtime += '.jpg'

            #faces = fc.detect_faces(frame,frame_img[frame_cnt])###############
            faces = fc.detect_faces(frame,mtime)###############
